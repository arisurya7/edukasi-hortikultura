...
@section('content')
    <div class="container">
         ...
         <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Penyakit Tanaman</h1>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                        <form method="POST" action="{{ isset($data) ? route('plant-disease.update', $data->id) :  route('plant-disease.store')}}" id="formDataPlant" enctype="multipart/form-data">
                            @csrf
                            @if (isset($data))
                                {{ method_field('PUT') }}
                            @endif
                            <div class="mb-3">
                                <label for="title" class="form-label">Nama Penyakit Tanaman<span class="text-danger">*</span>
                                </label>
                            ...
                            <a href="{{ route('plant-disease.index') }}" class="btn btn-outline-primary" id="back_button">Back</a>
                        </form>
                    </div>
                ...
                Swal.fire({
                    ...
                    if (data.status) {
                        Swal.fire(data.message, '', 'success').then(function() {
                            window.location = "{{ route('plant-disease.index') }}";
                        });
                    }
                });
